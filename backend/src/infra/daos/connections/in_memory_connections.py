...
from infra.daos.connections.base import IUsersConnectionsDAO, IChannelDAO


@dataclass
class InMemoryUsersConnectionsDAO(IUsersConnectionsDAO):
...
@dataclass
class InMemoryChannelUserDAO(IChannelDAO):
